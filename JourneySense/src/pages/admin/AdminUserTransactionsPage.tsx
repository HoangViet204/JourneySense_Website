        ...
        <header className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-stone-600">
              Xem giao dịch PayOS và giao dịch đổi gói bằng điểm của người dùng.
            </p>
            {userLabel ? (
              <p className="mt-2 inline-flex max-w-full items-center truncate rounded-lg bg-stone-50 px-2 py-1 text-[12px] font-semibold text-stone-700 ring-1 ring-stone-100">
                {userLabel}
              </p>
            ) : null}
          </div>
              ...
              <tbody className="divide-y divide-stone-100">
                {!items.length ? (
                  ...
                  items.map((x) => {
                    ...
                    const detailTo = `/admin/accounts/${userId}/transactions/${src}/${x.id}`
